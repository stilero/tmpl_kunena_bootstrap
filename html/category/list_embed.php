...
<div class="kblock kcategories-<?php echo intval($section->id) ?>">
	...
	<div class="kcontainer" id="catid_<?php echo intval($section->id) ?>">
		<div class="kbody">
<table class="table table-striped" id="kcat<?php echo intval($section->id) ?>">
	...
	?>
		...
		?>
			...
			<?php
				...
				echo '(' . $childforum->getTopics() . "/" . $childforum->getReplies() . ')';
			?>
			</div>
			<?php endforeach; ?>
			</div>
		...
		<?php endif; ?>
			...
			<td>
                            <?php echo $this->formatLargeNumber ( $category->getTopics() ) ?> <?php echo JText::_('COM_KUNENA_TOPICS');?>
			</td>

			<td>
                            <?php echo $this->formatLargeNumber ( $category->getReplies() ) ?> <?php echo JText::_('COM_KUNENA_GEN_REPLIES');?>
			</td>
